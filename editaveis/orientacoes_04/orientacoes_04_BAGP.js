...
(lib.Symbol2 = function(mode,startPosition,loop) {
	...
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#000000").ss(1,1,1).p("ABdGsIgbAAQgDArgiAAIhDAAQgiAAgCgrIgcAAADLn6IAAN0QAAAygyAAIg8AAIAAAdQAAAygyAAIhfAAQgyAAAAgyIAAgdIgyAAQgyAAAAgyIAAt0ABCGsIiMAA");
	...
	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#333333").s().p("Ag0IFQgyAAAAgyIAAgeIgyAAQgyAAAAgyIAAt0QAOgQAigDIAAATIE0AAIAAgRQApgBAIASIAAN0QAAAygyAAIg8AAIgcAAIAcAAIAAAeQAAAygyAAgAhKG1QACAsAiAAIBDAAQAiAAACgsIiLAAIgcAAgABdG1g");
...
(lib.Symbol1_1 = function(mode,startPosition,loop) {
	...
	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f().s("#333333").ss(1,1,1).p("");
...
(lib.Symbol1copy3 = function(mode,startPosition,loop) {
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#333333").ss(1,1,1).p("");
...
(lib.Symbol1copy2 = function(mode,startPosition,loop) {
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,1,1).p("");
	...
	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#979AA2").s().p("");
	this.shape_8.setTransform(-0.4,64.7);
...
// stage content:
(lib.orientacoes_04_BAGP = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.shape_73.graphics.f("#006E62").s().p("EhBCAEOIAAobMCCFAAAIAAIbg");
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"sounds/Nidia_animacao04.mp3?1530621577502", id:"Nidia_animacao04"},
		{src:"sounds/Poppy_clWho_Else8472_hifi_aditado.mp3?1530621577502", id:"Poppy_clWho_Else8472_hifi_aditado"}
	],
	preloads: []
};
