...
// stage content:
(lib.orientacoes_04_LPED = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.shape_73.graphics.f("#79108B").s().p("EhBCAEOIAAobMCCFAAAIAAIbg");
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"sounds/Nidia_animacao04.mp3?1530293977336", id:"Nidia_animacao04"},
		{src:"sounds/Poppy_clWho_Else8472_hifi_aditado.mp3?1530293977336", id:"Poppy_clWho_Else8472_hifi_aditado"}
	],
	preloads: []
};
