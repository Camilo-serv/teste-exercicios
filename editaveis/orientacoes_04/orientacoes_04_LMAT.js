...
// stage content:
(lib.orientacoes_04_LMAT = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.shape_73.graphics.f("#3E006E").s().p("EhBCAEOIAAobMCCFAAAIAAIbg");
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"sounds/Nidia_animacao04.mp3?1530293925085", id:"Nidia_animacao04"},
		{src:"sounds/Poppy_clWho_Else8472_hifi_aditado.mp3?1530293925085", id:"Poppy_clWho_Else8472_hifi_aditado"}
	],
	preloads: []
};
